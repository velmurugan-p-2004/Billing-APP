...
const Dashboard = () => {
    ...
    const lowStockItems = activeItems.filter(i => i.trackStock === true && i.stock < (i.lowStockLimit || 5)).length; // Use item limit if exists
            ...
            {lowStockItems > 0 && (
                <div className="mt-6">
                    ...
                    <div className="bg-white rounded-lg border divide-y">
                        {activeItems.filter(i => i.trackStock === true && i.stock < (i.lowStockLimit || 5)).slice(0, 5).map(item => (
